...
//     export default DailyPage
    ...
    import { View, Text, Image, ScrollView, TouchableOpacity,SafeAreaView, Modal, TextInput, Alert, StyleSheet} from 'react-native';
        ...
        <View style={styles.container}>
          <SafeAreaView style={styles.contentContainer}>
            <View style={styles.logo}>
              ...
              <Text style={{fontWeight:'700', fontSize:30}}>Daily List</Text> 
              </View>
